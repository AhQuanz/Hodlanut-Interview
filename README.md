...
> For me , the concept of promises took the most time for me as i have no prior experience in using promises. I was able to grasp the concept through tutorials online and find it quite similar to Java`s streams whereby the it is not evaluate until it is consumed. 
...
> instead of having to look up the user data in the server , we have have it send to the api. In addition, we have cache the latest price we have queried for the other request and do a updating of the price on this current request.
...
> I think the test is quite interesting , gives me an idea of what the company is doing on the day to day basis.